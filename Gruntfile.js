...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
      ...
      dist: {
        ...
        options: {
          ...
          paths: {
            ...
            'jquery-ui': '../../<%= yeoman.app %>/bower_components/jquery-ui/ui/jquery-ui',
            // 'json2': '../../<%= yeoman.app %>/bower_components/json2/json2',
    ...
    'jsbeautifier': {
      all: {
        src: ['app/scripts/**/*.js', '!app/scripts/vendor', 'Gruntfile.js', 'app.js']
      },
      options: {
        js: {
          jslintHappy: true,
